...
export default function Contact() {
  ...
  const sendMail: JSX.EventHandlerUnion<
    HTMLFormElement,
  ...
  return (
    <main id='contact' class={active() ? 'active' : ''} ref={mainRef}>
      ...
      <div id='contactInvite'>
        <div id='logoCont'>
          <a target='_blank' rel='noreferrer' href='https://github.com/ribru17'>
            <Github />
          </a>
          <a
            target='_blank'
            rel='noreferrer'
            href='https://www.linkedin.com/in/riley-bruins/'
          >
            <LinkedIn />
          </a>
        </div>
        <p>
          Check out my linked profiles on the left. If you have a question or
          you want to work with me, send me an email below!
        </p>
      </div>
